...
document.addEventListener('DOMContentLoaded', () => {
  ...
  tableBody.addEventListener('click', e =>{
    ...
    if (e.target.innerHTML === 'click to delete'){
      ...
      .then(r => {
        ...
        allDogs.splice(indexOfDogObject, (indexOfDogObject+1))
      })
...
function addHTMLforDog(dog) {
  return `<tr>
            ...
            <td><button data-id=${dog.id} type="button" name="delete">click to delete</button></td>
          </tr>`
}
